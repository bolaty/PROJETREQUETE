      ...
      this.route.queryParams.subscribe((params) => {
        ...
        this.apiService
          .postData(this.APP_URL, {
            ...
            RQ_DATEDEBUT: this.statusForms == true ?  date :this.info_session[4].valeur,
            RQ_DATEFIN: this.statusForms == true ?  date :this.info_session[5].valeur,
          ...
          .pipe(
            map((res: any) => {
              ...
              this.valtauxsatisfaction = parseInt(ts.TOTALPLAINTETRAITES) > 0
